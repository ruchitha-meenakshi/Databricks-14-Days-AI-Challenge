# Day 7: Workflows & Job Orchestration ⚙️
...
I have also scheduled the job to run at 2:00 AM daily:  
<img width="484" height="112" alt="Screenshot 2026-01-15 at 09 18 57" src="https://github.com/user-attachments/assets/21fb45e4-47fd-47fb-ad56-7674f4c10dcd" />

The code handles the logic (processing data). The Databricks UI handles the orchestration (time and sequence).

---
## Tasks
- [x] **Refactored Code:** Added `dbutils.widgets` to make the pipeline modular.
- [x] **Created Workflow:** Built a 3-step job (Bronze → Silver → Gold) in the Databricks UI.
...
* **`DAY 7 – Workflows & Job Orchestration.ipynb`**: A single, modular notebook containing the logic for Bronze, Silver, and Gold layers, controlled by `dbutils.widgets`.
